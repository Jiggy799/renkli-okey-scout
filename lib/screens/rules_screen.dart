          ...
          child: Column(
            ...
            children: [
              ...
              _section(
                ...
                children: [
                  _text('Will ein Spieler mit ÇIFTE gewinnen, muss sein Blatt so aussehen:'),
                  const SizedBox(height: 8),
                  _bullet('Genau 5 PAARE — jedes Paar muss identisch sein (z.B. Rot 3 + Rot 3)'),
                  _bullet('Die restlichen 4 Steine MÜSSEN eine Reihe in derselben Farbe bilden'),
                  _example('Rot 8, Rot 9, Rot 10, Rot 11'),
                  _note('Joker zählt als Platzhalter in der Reihe.'),
                ],
              ),
              const SizedBox(height: 16),
